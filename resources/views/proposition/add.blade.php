...
<form class="form-horizontal" method="POST" role ='form' action= "{{asset('proposition/store')}}">
    @csrf
    <div class="modal-body">
        <div class="form-group">
            ...
            <select class="select2_demo_2 form-control" name="idquestion" style="width: 100%">
                ...
                ?>
                    <option value="<?=$question['id']?>"><?=$question['intitule']?></option>
                <?php
                    }
                ?>
            </select>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Intitulé" name="choix">
        </div>
    </div>
